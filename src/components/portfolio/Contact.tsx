          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                I'm actively seeking Data Science, Data Engineering or Product Analytics roles at product-first firms. 
                Whether you're a recruiter, hiring manager, or just want to discuss data science and analytics, I'd love to connect!
              </p>
