        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              building recommendation engines, developing complex data driven solutions, and creating robust 
              data pipelines that drive measurable impact.
            </p>

            <div className="bg-blue-50 p-4 rounded-lg mb-6">
              <h4 className="font-semibold text-primary mb-2">Current Goal</h4>
              <p className="text-sm text-muted-foreground">
                Seeking Data Science, Data Engineering or Product Analytics roles at product-first firms 
                where I can leverage my technical expertise and business acumen to drive innovation.
              </p>
            </div>
